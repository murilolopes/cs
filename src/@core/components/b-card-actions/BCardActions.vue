    ...
    >
      ...
      >
        ...
        <div class="d-flex align-items-center">
          <b-button size="sm" variant="flat-primary" class="d-flex align-items-center mr-1" v-if="actionDelete" @click="$emit('delete-action')">
...
<script>
import {
  BCard, BCardTitle, BCardSubTitle, BCardBody, BCollapse, BOverlay, BButton
} from 'bootstrap-vue'
